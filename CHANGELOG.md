...
- Deprecated bot_data_examples directory and its contents (calendars.yaml, callbacks.yaml, components/menu_button.yaml, components/very_long_text.yaml, counters.yaml, layouts.yaml, main.yaml, menu.yaml, multiwidgets.yaml, scrolls.yaml, selects.yaml, switch.yaml).

### Changed

- Updated project URLs in pyproject.toml to reflect the new dialog-yml naming convention.
