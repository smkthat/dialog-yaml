...
from core.models.widgets.kbd.keyboard import GroupKeyboardField
        ...
        kwargs = clean_empty(
            {
                ...
                "preview_data": self.preview_data.func
                if self.preview_data
                else None,
            }
        )
        return Window(
            *[widget.to_object() for widget in self.widgets], **kwargs
        )
